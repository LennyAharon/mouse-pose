...
def make_markdown(canonical: list[str], entries: dict[str, dict]) -> str:
    lines = [
        ...
        "Evaluation scores only labeled cells (visible == 2). `pupil_center_right` is labeled "
        "directly by facemap (cam0 right-view frames) and cheese-3d since corpus v5; before "
        "that it was trainable only through hflip augmentation.",
        "",
